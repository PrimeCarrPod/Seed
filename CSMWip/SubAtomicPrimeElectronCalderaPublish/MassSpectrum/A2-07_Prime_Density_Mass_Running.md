...
Note: this gives a different scaling. Let us use the exact sum formula.
...
Note: let me be more careful. The exact formula from A2-03 Piece 07:
...
Note: this gives 4.780, but we need 5.331. Let us check the formula.
...
Let us use the correct initial conditions from A2-03 Piece 07:
...
Note: from A2-03 Piece 07, the exact formula is:
...
Let us use the verified results from A2-03, A2-04, A2-05, A2-06:
