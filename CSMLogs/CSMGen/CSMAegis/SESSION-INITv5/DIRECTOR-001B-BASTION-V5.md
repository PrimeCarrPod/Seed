...
```
git clone --depth 1 --filter=blob:none --sparse https://github.com/PrimeCarrPod/SEED.git && cd CarrPod && git sparse-checkout set CSMGen/CSMAegis/COMMS CSMGen/CSMAegis/SESSION-INITv5 CSMSOPP/MODULE-V2 && git checkout main && cat CSMGen/CSMAegis/SESSION-INITv5/DIRECTOR-001B-BASTION-V5.md
