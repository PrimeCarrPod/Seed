...
- [ ] **3b.1** Fix "BEGIN WORLDLINE" button in index_v3e.html to properly initialize and launch the 3D particle simulation (not go to broken menu)
- [ ] **3b.2** Integrate microbe icons for all 34 species (from tardigradia.html)
- [ ] **3b.3** Add Camera Follow mode (5s hold, smooth lerp)
- [ ] **3b.4** Add Motion Sensor mode (accelerometer/gyro via Android bridge)
- [ ] **3b.5** Add Click raycast → detail panel
- [ ] **3b.6** Preserve Android bridge (LandOLil interface)
- [ ] **3b.7** Use local Three.js/Chart.js/shaders (no CDN)
- [ ] **3b.8** Configurable particle count (200-3000 default, up to 150k)
- [ ] **3b.9** Create index_v3f.html with all fixes
- [ ] **3b.10** Push index_v3f.html to GitHub (root level)
- [ ] **3b.11** Update SubParticleReturnToWork.sh with progress
- [ ] **3b.12** Push session log to csmlogs/august26/
...
| **Phase 3b (TGPU v3f Fix)** | 🔄 **IN PROGRESS** | **Fix opening screen button navigation** |
| Phase 4 (TGPU004.htm) | ⏳ Pending | Awaits Phase 3b |
...
**Next Step:** **Phase 3b** — Fix TGPU v3f opening screen button navigation to properly launch 3D world with microbe icons, camera follow, motion sensor, and click detail. Then proceed to Phase 3.6 (test LOL_v4_staging) and Phase 4 (TGPU004.htm).
