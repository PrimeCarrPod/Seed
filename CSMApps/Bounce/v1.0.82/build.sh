#!/bin/bash
# ============================================================
# build.sh — No-Gradle APK Build for Bounce v1.0.82
# Wi-Fi scan window UI, Wi-Fi triangulation, EKF/Particle Filter/HMM zone classification, RTT ranging
...
PROJECT_DIR="/workspace/bb8f9c5f-e866-4346-a29c-8d72daa0ad2d/sessions/agent_5c7dbc6e-6f98-4432-ad3d-a23934805977/CSMApps/Bounce/v1.0.82"
