#!/bin/bash
# ============================================================
# build.sh — No-Gradle APK Build for Bounce v1.0.87
# Bluetooth 3D Spatial RSSI Tracking — Theory Visualization
...
PROJECT_DIR="/workspace/bb8f9c5f-e866-4346-a29c-8d72daa0ad2d/sessions/agent_ffc7f702-948b-4a00-b2ed-956874e356c8/CSMApps/Bounce/v1.0.87"
