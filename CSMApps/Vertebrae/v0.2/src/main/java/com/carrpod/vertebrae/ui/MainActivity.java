...
public class MainActivity extends AppCompatActivity {
    ...
    private void onSessionClick(KilosSession session) {
        // For v0.2, just show a toast - v0.3 will open floating window
    ...
    private static class GroupsAdapter extends RecyclerView.Adapter<GroupsAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group_chip, parent, false);
    ...
    private static class SessionsAdapter extends RecyclerView.Adapter<SessionsAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.tvSessionId.setText("ses_" + shortId);
            ...
            switch (session.getStatus()) {
                case CONNECTED:
                case HEARTBEAT_ACTIVE: statusColor = 0xFF3FB950; break;
                case CONNECTING:
                case RECONNECTING: statusColor = 0xFFD29922; break;
                case ERROR:
                case HEARTBEAT_FAILED: statusColor = 0xFFF85149; break;
                default: statusColor = 0xFF8B949E;
            }
            holder.statusIndicator.setBackgroundColor(statusColor);

            holder.btnOpen.setOnClickListener(v -> onClick.accept(session));
