...
### 2. The QCD Vacuum from Gap Statistics
...
In the prime gap picture, the record gap $d=14$ ($\rho$ meson scale) corresponds to the instanton that gives mass to the strange quark via the 't Hooft mechanism.
...
### 7. Lattice QCD from Prime Gap Algorithms

#### 7.1 Prime Gap Monte Carlo
...
| Quark masses | Record gaps at Dir 1.0 |
| $\Lambda_{\text{QCD}}$ | Mean gap at Dir 0.5 |
| $T_c$ | Dir 0.5 $\to$ 0.1 transition |
